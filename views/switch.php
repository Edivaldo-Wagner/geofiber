  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tela de Novo tipo de switch</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

      <form action="insert/insertswitch.php" method="POST">
      ...
      <p>
        ...
        <div class="form-group">
          ...
          <input type="number" id="Campo_numero_de_portas" class="form-control" name="Numero_de_portas" value="2" required>
        </div>
        <p>
        <div class="form-group">
          <p><input type="checkbox" id="checkbox-gerenciavel" class="fom-control" name="Gerenciavel" value="Sim"> <label for="checkbox-gerenciavel">Gerenciavel</label> </p>
        </div>
      </p>
       <div class="form-group">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Editar Tela de Novo tipo de switch </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update/updateswitch.php" method="POST">
      ...
      <p>
        ...
        <div class="form-group">
          <label>Número de portas</label>
          <input type="number" id="Campo_numero_de_portas_editar" class="form-control" name="Numero_de_portas" value="2" required>
        </div>
        <p>
        <div class="form-group">
          <p><input type="checkbox" id="checkbox-gerenciavel_editar" class="fom-control" name="Gerenciavel" value="Sim"> <label for="checkbox-gerenciavel_editar">Gerenciavel</label> </p>
        </div>
      </p>
       <div class="form-group">
          <label>Descrição</label>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="delete/deleteswitch.php" method="POST">
...
<!-- DELETE POP UP FORM (Bootstrap MODAL) -->
  ...
  <script>
    ...
    let Campo_numero_de_portas = document.getElementById("Campo_numero_de_portas")

    Campo_numero_de_portas.addEventListener("input", (event)=>{
     ...
     let Campo_numero_de_portas_editar = document.getElementById("Campo_numero_de_portas_editar")

    Campo_numero_de_portas_editar.addEventListener("input", (event)=>{
