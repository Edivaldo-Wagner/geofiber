...
if($_POST)
{
    ...
    $query = "INSERT INTO caixa_nivel_2 (nome, splitter, criado_em, tipo_splitter, cor, status_implementacao, observacao, escala) VALUES ('$nome', '$splitter', '$ano-$mes-$dia $horas:$minutos:$segundos', '$tipo_splitter', '$cor', '$status_implementacao', '$observacao', '$escala');";
