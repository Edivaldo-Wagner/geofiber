...
if($_POST)
{
    ...
    $query = "INSERT INTO concentrador (nome, status_implementacao, observacao, escala, criado_em) VALUES ('$nome', '$status_implementacao', '$observacao', '$escala', '$ano-$mes-$dia $horas:$minutos:$segundos');";
