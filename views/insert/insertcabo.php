...
if($_POST)
{
    ...
    $query = "INSERT INTO cabo (quantidade_fibras, quantidade_tubo_looses, cor, alto_sustentavel_cabo, status_implementacao, observacao, escala, criado_em) VALUES ('$quantidade_fibras', '$quantidade_tubo_looses', '$cor', '$alto_sustentavel_cabo', '$status_implementacao', '$observacao', '$escala', '$ano-$mes-$dia $horas:$minutos:$segundos');";
