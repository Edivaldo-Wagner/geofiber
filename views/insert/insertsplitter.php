...
if($_POST)
{
    ...
    $query = "INSERT INTO splitter (Codigo, Marca, Modelo, Prefixo, Tipo_de_entrada_saida, Nr_entradas, Nr_saidas, Atenuacao_1, Atenuacao_2, Balanceando, Permite_conexao, Descricao) VALUES ('$Codigo', '$Marca', '$Modelo', '$Prefixo', '$Tipo_de_entrada_saida', '$Numero_de_entradas', '$Numero_de_saidas', '$Atenuacao_1', '$Atenuacao_2', '$balanceado', '$Permitir_conexao_de_cliente', '$Descricao');";
