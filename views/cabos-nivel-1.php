  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tela de Novo tipo de cabo nível 1</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

      <form action="insert/insertcabo.php" method="POST">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Editar Tela de Novo tipo de cabo nível 1 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update/updatecabo.php" method="POST">
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="delete/deletecabo.php" method="POST">
  ...
  <script>
     ...
     document.querySelector("table").addEventListener("click", (event)=>{
        ...
        if(event.target.classList == "checkbox-caixa-em-uso"){
            ...
            localStorage.setItem("id_cabo_nivel_1", id_tabela)
            
            localStorage.setItem("cor_cabo_nivel_1", cor_tabela)
            
            localStorage.setItem("quantidade_fibras_cabo_nivel_1", quantidade_fibras_tabela)
            
            localStorage.setItem("quantidade_tubo_looses_cabo_nivel_1", quantidade_tubo_looses_tabela)
            
            localStorage.setItem("alto_sustentavel_cabo_nivel_1", alto_sustentavel_cabo_tabela)
            
            localStorage.setItem("status_implementacao_cabo_nivel_1", status_implementacao_tabela)
            
            localStorage.setItem("observacao_cabo_nivel_1", observacao_tabela)

            localStorage.setItem("escala_cabo_nivel_1", escala_tabela)
    ...
    window.onload = ()=>{
        ...
        if(localStorage.getItem("id_cabo_nivel_1") == null){
            
            localStorage.setItem("id_cabo_nivel_1");
        }
        
        if(localStorage.getItem("cor_cabo_nivel_1") == null){
            
            localStorage.setItem("cor_cabo_nivel_1");
        }
         
        if(localStorage.getItem("quantidade_fibras_cabo_nivel_1") == null){
            
            localStorage.setItem("quantidade_fibras_cabo_nivel_1");
        }
        
        if(localStorage.getItem("quantidade_tubo_looses_cabo_nivel_1") == null){
            
            localStorage.setItem("quantidade_tubo_looses_cabo_nivel_1");
        }
        
        if(localStorage.getItem("alto_sustentavel_cabo_nivel_1") == null){
            
            localStorage.setItem("alto_sustentavel_cabo_nivel_1");
        }
        
        if(localStorage.getItem("status_implementacao_cabo_nivel_1") == null){
            
            localStorage.setItem("status_implementacao_cabo_nivel_1");
        }
        
        if(localStorage.getItem("observacao_cabo_nivel_1") == null){
            
            localStorage.setItem("observacao_cabo_nivel_1");
        }
            
        if(localStorage.getItem("escala_cabo_nivel_1") == null){
            
            localStorage.setItem("escala_cabo_nivel_1")
          } 
        ...
        let id_tabela = document.querySelectorAll(".id-tabela")
           ...
           let checkbox_caixa_em_uso = document.querySelectorAll(".checkbox-caixa-em-uso")
            ...
            for(let i = 0; i < checkbox_caixa_em_uso.length; i++){
                ...
                if(id_tabela[i].innerText == localStorage.getItem("id_cabo_nivel_1")){
