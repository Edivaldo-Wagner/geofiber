  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tela de Novo tipo de cabo drop</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

      <form action="insert/insertcabodrop.php" method="POST">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Editar Tela de Novo tipo de Cabo drop </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update/updatecabodrop.php" method="POST">
         ...
         <div class="form-group">
          <label>Cor</label>
          <input type="color" class="form-control" id="campo-1" name="cor" placeholder="Escolhe uma cor">
        </div>
       ...
       <div class="form-group">
          ...
          <textarea class="form-control" id="campo-2" name="observacao"></textarea>
        </div>
           
    <div class='form-group'>
        <label>Escala (mm)</label>
        <select class='form-control' id="campo-3" name="escala" required>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="delete/deletedrop.php" method="POST">

                    <div class="modal-body">

                        <input type="hidden" name="delete_id" id="delete_id">

                        <h4> Pretende deletar este cabo drop ??</h4>
                    </div>
                    <div class="modal-footer">
  ...
  <script>
     ...
     document.querySelector("table").addEventListener("click", (event)=>{
        ...
        if(event.target.classList == "btn btn-success editbtn"){
            ...
            document.getElementById("campo-1").value = container.querySelector(".cor").innerText 

            document.getElementById("campo-2").value = container.querySelector(".observacao").innerText 

            document.getElementById("campo-3").value = container.querySelector(".escala").innerText 
        ...
        if(event.target.classList == "checkbox-caixa-em-uso"){
            ...
            localStorage.setItem("id_cabo_drop", id_tabela)
            
            localStorage.setItem("cor_cabo_drop", cor_tabela)
            
            localStorage.setItem("observacao_cabo_drop", observacao_tabela)

            localStorage.setItem("escala_cabo_drop", escala_tabela)
    ...
    window.onload = ()=>{
        ...
        if(localStorage.getItem("id_cabo_drop") == null){
            
            localStorage.setItem("id_cabo_drop");
        }
        
        if(localStorage.getItem("cor_cabo_drop") == null){
            
            localStorage.setItem("cor_cabo_drop");
        }
         
        if(localStorage.getItem("observacao_cabo_drop") == null){
            
            localStorage.setItem("observacao_cabo_drop");
        }
            
        if(localStorage.getItem("escala_cabo_drop") == null){
            
            localStorage.setItem("escala_cabo_drop")
          } 
        ...
        let id_tabela = document.querySelectorAll(".id-tabela")
           ...
           let checkbox_caixa_em_uso = document.querySelectorAll(".checkbox-caixa-em-uso")
            ...
            for(let i = 0; i < checkbox_caixa_em_uso.length; i++){
                ...
                if(id_tabela[i].innerText == localStorage.getItem("id_cabo_drop")){
