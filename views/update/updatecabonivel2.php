...
if(isset($_POST['updatedata']))//updatedata
    ...
    $horas = date("h");
     ...
     $segundos = date("s");
        ...
        $query = "UPDATE cabo_nivel_2 SET quantidade_fibras='$quantidade_fibras', quantidade_tubo_looses='$quantidade_tubo_looses', cor='$cor' , alto_sustentavel_cabo='$alto_sustentavel_cabo', status_implementacao='$status_implementacao', observacao='$observacao', escala='$escala', modificado_em='$ano-$mes-$dia $horas:$minutos:$segundos' WHERE id='$id'";
