...
if(isset($_POST['updatedata']))//updatedata
    ...
    $horas = date("h");
     ...
     $segundos = date("s");
        ...
        $query = "UPDATE caixa SET nome='$nome', splitter='$splitter', modificado_em='$ano-$mes-$dia $horas:$minutos:$segundos', tipo_splitter='$tipo_splitter', cor='$cor', status_implementacao='$status_implementacao', observacao='$observacao', escala='$escala' WHERE id='$id'";
