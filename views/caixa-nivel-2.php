  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tela de Novo tipo de caixa nível 2</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

      <form action="insert/insertcaixanivel2.php" method="POST">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Editar Tela de Novo tipo de caixa nível 2 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update/updatecaixanivel2.php" method="POST">
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="delete/deletecaixanivel2.php" method="POST">

                    <div class="modal-body">

                        <input type="hidden" name="delete_id" id="delete_id">

                        <h4> Pretende deletar esta caixa nível 2 ??</h4>
                    </div>
                    <div class="modal-footer">
      ...
      <div class="container-fluid">
           <!-- Button trigger modal -->
            ...
            <div class="card" style="margin: 20px 0px 0px 0px;">
                ...
                $query = "SELECT * FROM caixa_nivel_2";
  ...
  <script>
    ...
    document.querySelector("table").addEventListener("click", (event)=>{
        ...
        if(event.target.classList == "checkbox-caixa-em-uso"){
            ...
            localStorage.setItem("id_caixa_nivel_2", id_tabela)
            
            localStorage.setItem("nome_caixa_nivel_2", nome_tabela)
            
            localStorage.setItem("splitter_caixa_nivel_2", splitter_tabela)
            
            localStorage.setItem("tipo_splitter_caixa_nivel_2", tipo_splitter_tabela)
            
            localStorage.setItem("cor_caixa_nivel_2", cor_tabela)
            
            localStorage.setItem("status_implementacao_caixa_nivel_2", status_implementacao_tabela)
            
            localStorage.setItem("observacao_caixa_nivel_2", observacao_tabela)

            localStorage.setItem("escala_caixa_nivel_2", escala_tabela)
    ...
    window.onload = ()=>{
        ...
        if(localStorage.getItem("id_caixa_nivel_2") == null){
            
            localStorage.setItem("id_caixa_nivel_2");
        }
        
        if(localStorage.getItem("nome_caixa_nivel_2") == null){
            
            localStorage.setItem("nome_caixa_nivel_2");
        }
        
        if(localStorage.getItem("splitter_caixa_nivel_2") == null){
            
            localStorage.setItem("splitter_caixa_nivel_2");
        }
        
        if(localStorage.getItem("tipo_splitter_caixa_nivel_2") == null){
            
            localStorage.setItem("tipo_splitter_caixa_nivel_2");
        }
        
        if(localStorage.getItem("cor_caixa_nivel_2") == null){
            
            localStorage.setItem("cor_caixa_nivel_2");
        }
        
        if(localStorage.getItem("status_implementacao_caixa_nivel_2") == null){
            
            localStorage.setItem("status_implementacao_caixa_nivel_2");
        }
        
        if(localStorage.getItem("observacao_caixa_nivel_2") == null){
            
            localStorage.setItem("observacao_caixa_nivel_2");
        }
            
        if(localStorage.getItem("escala_caixa_nivel_2") == null){
            
            localStorage.setItem("escala_caixa_nivel_2")
          } 
        ...
        let id_tabela = document.querySelectorAll(".id-tabela")
           ...
           let checkbox_caixa_em_uso = document.querySelectorAll(".checkbox-caixa-em-uso")
            ...
            for(let i = 0; i < checkbox_caixa_em_uso.length; i++){
                ...
                if(id_tabela[i].innerText == localStorage.getItem("id_caixa_nivel_2")){
